...
while (1) {
    eventDate = prompt("Could you please tell me the date of the Event ? (YYYY,MM,DD) ");
...
let birthdate = new Date(+eventDateArray[0],(+eventDateArray[1])-1,+eventDateArray[2]);
        ...
        function counter() {
            ...
            document.querySelector("p").innerHTML = `${day}d &nbsp&nbsp ${hour}h &nbsp&nbsp ${min}m &nbsp&nbsp ${time}s`;
        }